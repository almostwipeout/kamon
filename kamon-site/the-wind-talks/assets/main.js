...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.instance-4', { style: 'fade-in', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-1', { style: 'fade-in', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-3', { style: 'fade-in', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-2', { style: 'fade-in', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
