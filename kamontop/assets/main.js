...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('.text-component.instance-4', { style: 'flip-backward', speed: 3000, intensity: 10, threshold: 2, delay: 0, stagger: 1250, staggerOrder: 'random', staggerSelector: ':scope > *', replay: false });
		onvisible.add('.text-component.instance-9', { style: 'fade-down', speed: 3000, intensity: 5, threshold: 3, delay: 1000, replay: false });
		onvisible.add('.text-component.instance-1', { style: 'fade-down', speed: 1500, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-2', { style: 'fade-left', speed: 3000, intensity: 5, threshold: 3, delay: 1000, replay: false });
		onvisible.add('.container-component.instance-1', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-4', { style: 'fade-left', speed: 3000, intensity: 5, threshold: 3, delay: 1000, replay: false });
		onvisible.add('.image-component.instance-2', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-5', { style: 'fade-down', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.instance-3', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.instance-4', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-8', { style: 'fade-down', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.instance-5', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-3', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-6', { style: 'fade-down', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-6', { style: 'fade-left', speed: 3000, intensity: 5, threshold: 3, delay: 1500, replay: false });
		onvisible.add('.container-component.instance-4', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-1', { style: 'fade-left', speed: 3000, intensity: 5, threshold: 3, delay: 1750, replay: false });
		onvisible.add('.container-component.instance-5', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-7', { style: 'fade-down', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-3', { style: 'fade-left', speed: 3000, intensity: 5, threshold: 3, delay: 2000, replay: false });
		onvisible.add('.container-component.instance-2', { style: 'blur-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.instance-3', { style: 'fade-down', speed: 3000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.instance-1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-5', { style: 'fade-left', speed: 3000, intensity: 5, threshold: 3, delay: 2250, replay: false });
